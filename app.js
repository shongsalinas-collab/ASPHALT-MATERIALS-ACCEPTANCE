  ...
  if (!rows.length) {
    ...
    tbody.innerHTML = rows.map(function(d) {
      ...
      return '<tr'+op+'>'+
        ...
        '<td>'+(d.labNo||'--')+'</td>'+
        '<td>'+(d.projectId||'--')+'</td>'+
        '<td title="'+(d.projectTitle||'')+'">'+(d.projectTitle||'--')+'</td>'+
        '<td title="'+(d.projectLocation||'')+'">'+(d.projectLocation||'--')+'</td>'+
        '<td>'+(d.client||'--')+'</td>'+
        '<td>'+jmfLbl+'</td>'+
        '<td>'+rateLbl+'</td>'+
        '<td>'+(d.loadNo||'--')+'</td>'+
